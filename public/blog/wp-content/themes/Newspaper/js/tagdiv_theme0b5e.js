...
var td_history = {
    ...
    get_mod_rewrite_base_url: function () {
        ...
        if (full_url.charAt(full_url.length - 1) == '../index.html') {
        ...
        return full_url.substring(0, full_url.lastIndexOf("../index.html"))+ '/';
    ...
    get_mod_rewrite_pagination: function () {
        ...
        var last_url_parameter = full_url.substring(full_url.lastIndexOf("../index.html")+1, full_url.length);
