...
class HomeController extends Controller
{
 ...
 $projects = slider::limit(40)->get();
   ...
   $Categories_Products_parent = Categories_Products::where('parentid', 0 )->latest()->get();
   $Categories_Products_children = Categories_Products::where('parentid', 0 )->latest()->get();

		 return view('main.services',
            [
                 'Categories_Products_parent' => $Categories_Products_parent ,
                 'Categories_Products_children' => $Categories_Products_children 
            ]);
    }
